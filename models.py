...
class Resort(db.Model):
    ...
    VALID_PASS_BRANDS = ['Epic', 'Ikon', 'Indy', 'MountainCollective', 'PowderAlliance', 'Freedom', 'SkiCalifornia', 'Other', 'None']
...
class ResortPass(db.Model):
    ...
    VALID_PASS_NAMES = ['Epic', 'Ikon', 'Indy', 'MountainCollective', 'PowderAlliance', 'Freedom', 'SkiCalifornia', 'Other']

...
os.environ.pop("BASELODGE_MIGRATION_TARGET", None)
os.environ.pop("BASELODGE_MIGRATION_REPLIT_IDENTITY_HASH", None)
os.environ.pop(
    "BASELODGE_MIGRATION_SUPABASE_DEVELOPMENT_IDENTITY_HASH", None
)
os.environ.pop(
    "BASELODGE_MIGRATION_SUPABASE_PRODUCTION_IDENTITY_HASH", None
)
os.environ.pop("BASELODGE_CONFIRM_PRODUCTION_MIGRATION", None)
